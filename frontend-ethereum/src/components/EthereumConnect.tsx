...
export function EthereumConnect() {
  ...
  const connector = connectors[0];
	...
	function signinEthereum() {
		console.log('signinEthereum clicked');
//		connect({ connector });
  ...
  return (
      ...
      {isConnected ? (
        ...
        <Button
          className="w-100 bg-blue-500 rounded-xl hover:bg-blue-600 shadow-xl md:px-10 font-semibold"
          onClick={signinEthereum}
        >
		      <Image
            src="/src/assets/images/metamask-logo.svg"
            alt="Metamask Logo"
            width={180}
            height={180}
				    fluid
