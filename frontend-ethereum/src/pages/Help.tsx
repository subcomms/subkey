...
export function Help() {
  return (
    <Container className="font-lato text-subcomms-black">
      <p>
          This Public Key Server allows you to associate your ENS (Ethereum Name System) domain with a PGP Public Key by signing your Public Key with the Crypto Wallet holding your ENS name, thus proving that the holder of the PGP Public Key is the same holder of the ENS domain.
      </p>
      <p>
        Users can then utilize applications such as <Link to={SUBCHAT_URL}>Subchat</Link> (and others) to send encrypted messages directly to a ENS domain.
      </p>
